...
Artifacts must be pinned, because poppy processes the pinned files. The pinned filename must be of the format `<repository_name>_install.json`. For example `maven_install.json`.
